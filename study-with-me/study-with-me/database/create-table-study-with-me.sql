...
values ('abc', 'abc@gmail.com', 'user', 'user', 'active', 'Hello girls');
Insert into messages (subject,email,createdBy,updatedBy,status,message)
values ('abcd', 'abcd@gmail.com', 'user', 'user', 'active', 'Hello boys');
Insert into messages (subject,email,createdBy,updatedBy,status,message)
values ('abcde', 'abcde@gmail.com', 'user', 'user', 'active', 'good boy');
Insert into messages (subject,email,createdBy,updatedBy,status,message)
values ('abcdef', 'abcdef@gmail.com', 'user', 'user', 'active', 'trap boy');
Insert into messages (subject,email,createdBy,updatedBy,status,message)
values ('abcdefg', 'abcdefg@gmail.com', 'user', 'user', 'active', 'bad boy');